...
public class MyProfilePanel extends JPanel {
	...
	public MyProfilePanel() {
		...
		modifyButton.setFont(new Font("배달의민족 도현", Font.PLAIN, 0));
		...
		lblNewLabel_1.setFont(new Font("배달의민족 도현", Font.PLAIN, 16));
		lblNewLabel_1.setForeground(Color.WHITE);
		lblNewLabel_1.setBounds(0, -11, 200, 42);
		add(lblNewLabel_1);
